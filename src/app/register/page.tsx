    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <div className="mx-auto h-12 w-12 rounded-xl bg-gradient-to-br from-brand-500 to-brand-700" />
          <h1 className="mt-4 text-2xl font-bold text-gray-900">Create your salon</h1>
          <p className="mt-2 text-sm text-gray-600">Get started with Full Chair in 2 minutes</p>
        </div>
